/*
 *  THIS IS POLICY FINDER MODULE implemented by CNR for supporting DATA USAGE CONTROL
 ...
 */
public class InputStreamBasedPolicyFinderModule extends PolicyFinderModule{
     ...
     */
	public static Logger log = Logger.getLogger(InputStreamBasedPolicyFinderModule.class.getName());

  ...
  extends RuleCombiningAlgorithm
{
  ...
  static
  {
    try
    {
      identifierURI = new URI("urn:oasis:names:tc:xacml:3.0:rule-combining-algorithm:permit-unless-deny");
    }
...
/* Location:
 * Qualified Name:     org.wso2.balana.combine.xacml3.PermitUnlessDenyRuleAlg
